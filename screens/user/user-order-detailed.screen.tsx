...
interface UserOrderDetailedScreenProps {
...
const UserOrderDetailedScreen: React.FC<UserOrderDetailedScreenProps> = ({
  navigation,
  route,
}) => {
    ...
    <View style={styles.screen}>
      <View style={styles.orderSummary}>
        ...
        {/* <View style={styles.orderAction}>
          <Button disabled={orderDetailed.isConfirmed} title="Potvrdi" onPress={() => console.log("Confirming...")} />
        </View> */}
      </View>
      <FlatList
        ...
        renderItem={({ item }) => {
          return <OrderedProductItem item={item} isUserOrder/>;
        }}
      />
    </View>
  );
...
export default UserOrderDetailedScreen;
